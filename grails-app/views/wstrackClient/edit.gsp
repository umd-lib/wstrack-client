...
<html>
	...
	<body>
		<a href="#edit-wstrackClient" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-wstrackClient" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${wstrackClientInstance?.version}" />
				<fieldset class="form">
