...
<html>
	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				<li><a class="home" href="${createLink((uri: '/wstrack/track'))}"><g:message code="default.home.label"/></a></li>
				<li><g:link class="list" action="WstrackClient"><g:message code="default.list.label" args="[entityName]" /></g:link></li>
			</ul>
		</div>
